  ...
  return(
    <Container fluid
      ...
      <div className="proj-description">
        ...
        <p className="desc-content">Etelage is a solo project created for users to learn and appreciate existing art and other user's aesthetic on a fully interactive platform. The concept is to allow users to search over thousands of artwork and curate their own exhibits and share with other users. Etelage accesses several APIs including the Harvard's Art Museum API, the MET Museum API, and Artsy's API allowing users access to several thousands of exhibits and artwork.</p>
        ...
        <p className="desc-content">Etelage was developed in less than 3 days leaving missing components and key pieces to the full immersive experience. With more time, the application would have all features mentioned with the ability for users to fully customize their exhibit experiences. In the future, I plan on configuring the application to be a mobile-app, develop smart algorithms to better customize a user's feed, and incorporate further customization abilities for a user's immersive exhibit experience.</p>
