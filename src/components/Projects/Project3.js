  ...
  return(
    <Container fluid
      ...
      <div className="proj-description">
        ...
        <p className="desc-content">In the future, I'd like to configure the app to be mobile-responsive and continue to build the interal API with restaurant, things-to-do, and places to stay data. Additionally, I'd like to integrate hotel, flight, and car rental services from external databases.</p>
